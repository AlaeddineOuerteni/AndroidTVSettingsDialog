...
public interface ScrollAdapterBase extends ListAdapter {
    ...
    /**
     * optional method to be implemented by {@link android.widget.Adapter}. {@link #viewRemoved(View)} is called
     ...
     * parameter in next {@link android.widget.Adapter#getView(int, View, ViewGroup)}.
     */
